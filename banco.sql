...
CREATE TABLE IF NOT EXISTS `os` (
  ...
  INDEX `fk_os_tecnicos1` (`tecnico_id` ASC),
...
CREATE TABLE IF NOT EXISTS `whatsapp_config` (
  `id`         INT(11) NOT NULL AUTO_INCREMENT,
  `instancia`  VARCHAR(80) NOT NULL DEFAULT 'default',
  `apikey`     VARCHAR(200) NOT NULL,
  `base_url`   VARCHAR(200) NOT NULL DEFAULT 'http://localhost:3005',
...
INSERT IGNORE INTO `msg_templates` (`id`, `titulo`, `categoria`, `mensagem`, `variaveis`) VALUES
(1, 'Cadastro de Cliente', 'Confirmacao', '👋 Olá, *{nome_cliente}*! Seja bem-vindo(a) à *{empresa}*! 🎉\n\nSeu cadastro foi realizado com sucesso em nossa base de clientes.\n\nEstamos à disposição para qualquer dúvida ou serviço que precisar.\n\nAtenciosamente,\n🏢 *{empresa}*', '{nome_cliente},{empresa}'),
(2, 'Ordem de Serviço Iniciada', 'Confirmacao', '🔧 Olá, *{nome_cliente}*!\n\nSua *Ordem de Serviço nº {num_os}* foi iniciada!\n\n👨‍🔧 Técnico responsável: *{tecnico}*\n📅 Data de abertura: {data_hora}\n\nAcompanharemos seu atendimento e avisaremos quando houver novidades.\n\nQualquer dúvida, entre em contato conosco.\n\n🏢 *{empresa}*', '{nome_cliente},{num_os},{tecnico},{data_hora},{empresa}'),
(3, 'Ordem de Serviço Finalizada', 'Cobranca', '✅ Olá, *{nome_cliente}*!\n\nSua *Ordem de Serviço nº {num_os}* foi *concluída com sucesso*! 🎊\n\n💰 Valor total: *{valor}*\n\n🔗 Para visualizar ou efetuar o pagamento, acesse:\n{link_cobranca}\n\nAgradecemos a preferência! Em caso de dúvidas, estamos à disposição.\n\n🏢 *{empresa}*', '{nome_cliente},{num_os},{valor},{link_cobranca},{empresa}'),
(4, 'Aviso Importante', 'Informativo', '⚠️ *Aviso Importante* — *{empresa}*\n\nOlá, *{nome_cliente}*!\n\nGostaríamos de comunicar uma informação importante sobre nossos serviços.\n\nFique atento às nossas atualizações e não hesite em entrar em contato caso precise de suporte.\n\n🏢 *{empresa}*', '{nome_cliente},{empresa}'),
(5, 'Promoção Especial', 'Promocao', '🎁 *PROMOÇÃO ESPECIAL* 🎁\n\nOlá, *{nome_cliente}*!\n\nTemos uma oferta exclusiva para você! 🔥\n\nNão perca essa oportunidade de aproveitar nossos melhores preços e condições.\n\n📞 Entre em contato agora mesmo e garanta a sua!\n\n🏢 *{empresa}*', '{nome_cliente},{empresa}'),
(6, 'Lembrete de Cobrança', 'Cobranca', '💳 *Lembrete de Pagamento*\n\nOlá, *{nome_cliente}*!\n\nIdentificamos que o pagamento referente à *OS nº {num_os}* no valor de *{valor}* ainda está em aberto.\n\n🔗 Acesse o link abaixo para regularizar:\n{link_cobranca}\n\nCaso já tenha efetuado o pagamento, por favor desconsidere esta mensagem.\n\nDúvidas? Estamos à disposição! 😊\n\n🏢 *{empresa}*', '{nome_cliente},{num_os},{valor},{link_cobranca},{empresa}');
